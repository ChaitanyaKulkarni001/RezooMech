...
import AudioTranslator from "./AudioTranslater";
export const CornerDisplayName = ({
  ...
  return (
    <>
    {/* <h1 classname='bg-white text-white' >hello my dear</h1> */}
    <div className="fixed top-5 right-5 z-50  text-white p-4 shadow-md rounded-lg" >

            <h1 className=' text-white fixed top-0 right-0' >Translation </h1>
            {/* <AudioTranslator isLocal={isLocal}  /> */}
            {!isLocal && <AudioTranslator isLocal={isLocal} />}
                      ...
                      {ReactDOM.createPortal(
                        <div
                          ...
                          <div
                            ...
                            className="bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 "
                          >
                            <div
...
export function ParticipantView({ participantId }) {
  ...
  const googleTranslateElementInit = () => {
    new window.google.translate.TranslateElement(
      {
        pageLanguage: "en", // Assuming original language is English
        autoDisplay: false
      },
